...
```{r}
rename_columns(clean_coldwater_coral)
rename_columns(clean_mangroves)
rename_columns(clean_saltmarshes)
rename_columns(clean_seagrasses)
rename_columns(clean_warm_coral)
```
...
# Beta Regression
```{r}
betareg(proportion_protected ~ pc_gdp_2016,
